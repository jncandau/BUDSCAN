#!/bin/bash
#SBATCH --job-name=XAM_201308
#SBATCH --time=00:05:00
#SBATCH --mem=16G
#SBATCH --cpus-per-task=1
#SBATCH --array=1-4206
#SBATCH -o /home/jcandau/Radar/BUDSCAN/logs/XAM_201308_%j.out
#SBATCH -e /home/jcandau/Radar/BUDSCAN/logs/XAM_201308_%j.err
...
YMDT=$(unzip -l ~/scratch/Inputs/XAM_201308_volumescan.zip | grep CONVOL | cut -d ":" -f 2 | cut -d " " -f 4 | cut -d "~" -f 1 | sort -n | sed -n ${SLURM_ARRAY_TASK_ID}p)
 
# Unzip specific input files in TEMP_DIR
mkdir ${SLURM_TMPDIR}/IRIS
unzip /home/jcandau/scratch/Inputs/XAM_201308_volumescan.zip ${YMDT}* -d ${SLURM_TMPDIR}/IRIS
